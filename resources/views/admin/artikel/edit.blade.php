...
<div class="px-4 sm:px-6 py-5 w-full mx-auto" style="max-width: 1280px;">
    ...
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-6">
        <div>
            ...
            <p class="text-sm" style="color: #8b7e74;">Perbarui detail dan informasi artikel edukasi zakat</p>
        </div>
        ...
        <form action="{{ route('admin.artikel.update', $artikel) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="lg:col-span-1 space-y-5">
                    ...
                    <div>
                        ...
                        <img src="{{ asset('storage/' . $artikel->image) }}" alt="{{ $artikel->title }}" class="w-full h-44 object-cover rounded-xl border border-[#f0ece6]">
                    </div>
                    @endif

                    <div id="image-preview" class="hidden">
                        <label class="block text-xs font-semibold mb-1.5" style="color: #1c0f0a;">Preview Gambar Baru</label>
                    ...
                    <div class="p-4 rounded-xl border border-[#f0ece6] bg-[#faf8f5]">
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="text-xs font-semibold" style="color: #1c0f0a;">Publikasikan artikel sekarang</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-3 pt-5 border-t border-[#f0ece6]">
                ...
                <button type="submit"
                    ...
                    <i class="bi bi-check-lg text-sm"></i> Perbarui Artikel
                </button>
            </div>
        </form>
    </div>
