        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
                <div class="rounded-2xl p-5 sm:p-6 bg-white border border-[#f0ece6]" style="box-shadow: 0 1px 3px rgba(28,15,10,0.04);">
                    ...
                    <div class="rounded-xl overflow-hidden mb-4 border border-[#f0ece6] relative bg-gray-50 flex items-center justify-center" style="height: 220px;">
                        @if(!$campaign->photo)
                        ...
                        @endif
                        <img id="preview" src="{{ $campaign->photo ? asset('storage/'.$campaign->photo) : '' }}"
                            alt="Preview Foto"
                            class="w-full h-full object-cover relative z-10 {{ $campaign->photo ? '' : 'hidden' }}">
                    </div>
