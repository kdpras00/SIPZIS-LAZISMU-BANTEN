...
<div class="px-4 sm:px-6 py-5 w-full mx-auto" style="max-width: 1280px;">
    ...
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-6">
        <div>
            <h2 class="text-xl font-bold mb-1" style="color: #1c0f0a;">Edit Program</h2>
            <p class="text-sm" style="color: #8b7e74;">Perbarui informasi detail program {{ $program->name }}</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                        <div>
                            ...
                            <x-custom-select 
                                ...
                                :selected="old('category', $program->category)" 
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit"
                        ...
                        <i class="bi bi-check-lg text-sm"></i> Perbarui Program
                    </button>
                </div>
            </div>
            ...
            <div>
                <div class="rounded-2xl p-5 sm:p-6 bg-white border border-[#f0ece6]" style="box-shadow: 0 1px 3px rgba(28,15,10,0.04);">
                    ...
                    <div class="rounded-xl overflow-hidden mb-3 border border-[#f0ece6] relative bg-gray-50 flex items-center justify-center" style="height: 200px;">
                        @if(!$program->photo)
                        <div id="svg-placeholder" class="absolute inset-0 flex items-center justify-center">
                        ...
                        @endif
                        <img id="preview"
                            src="{{ $program->photo ? asset('storage/'.$program->photo) : '' }}"
                            alt="Preview Foto"
                            class="w-full h-full object-cover relative z-10 {{ $program->photo ? '' : 'hidden' }}">
                    </div>
