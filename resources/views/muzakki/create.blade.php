...
<div class="px-4 sm:px-6 py-5 w-full mx-auto" style="max-width: 1280px;">
    ...
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-6">
        <div>
            <h2 class="text-xl font-bold mb-1" style="color: #1c0f0a;">Tambah Muzakki Baru</h2>
            <p class="text-sm" style="color: #8b7e74;">Menambahkan data muzakki baru ke dalam sistem</p>
        </div>
        ...
        <form action="{{ route('muzakki.store') }}" method="POST" id="muzakkiForm">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        <label for="email" class="block text-xs font-semibold mb-1.5" style="color: #1c0f0a;">
                            Email
                        </label>
                        <input type="email" id="email" name="email"
                            class="w-full h-11 px-4 rounded-xl border border-[#e8e0d6] bg-white text-xs font-medium text-[#1c0f0a] focus:border-[#c2410c] focus:ring-2 focus:ring-[#c2410c]/10 transition-all outline-none @error('email') border-red-500 @enderror"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        <label for="date_of_birth" class="block text-xs font-semibold mb-1.5" style="color: #1c0f0a;">
                            Tanggal Lahir
                        </label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label for="occupation" class="block text-xs font-semibold mb-1.5" style="color: #1c0f0a;">
                            Pekerjaan / Kategori
                        </label>
                        <x-custom-select
                            id="occupation"
                            name="occupation"
                            placeholder="Pilih Pekerjaan / Kategori"
                            ...
                            :options="[
                                ...
                                'tNI_POLRI' => 'TNI / POLRI',
                                'profesional' => 'Dokter / Pengacara / Profesional',
                                'pensiunan' => 'Pensiunan',
                                'lainnya' => 'Lainnya'
                            ]"
                        />
                    ...
                    <div>
                        ...
                        <x-custom-select
                            ...
                            :options="['1' => 'Aktif & Terverifikasi', '0' => 'Menunggu Verifikasi']"
                        />
                        @error('is_active')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="mb-6 pt-5 border-t border-[#f0ece6]">
                <h6 class="text-xs font-bold uppercase tracking-wider mb-4 flex items-center gap-2" style="color: #c2410c;">
                    <i class="bi bi-geo-alt-fill text-sm"></i> Informasi Alamat
                </h6>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        <label for="postal_code" class="block text-xs font-semibold mb-1.5" style="color: #1c0f0a;">
                            Kode Pos (Tepat 5 Angka)
                        </label>
                        <input type="text" id="postal_code" name="postal_code"
                            class="w-full h-11 px-4 rounded-xl border border-[#e8e0d6] bg-white text-xs font-medium text-[#1c0f0a] focus:border-[#c2410c] focus:ring-2 focus:ring-[#c2410c]/10 transition-all outline-none @error('postal_code') border-red-500 @enderror"
            ...
            <div class="flex justify-end gap-3 pt-5 border-t border-[#f0ece6]">
                ...
                <button type="submit"
                    ...
                    <i class="bi bi-check-lg text-sm"></i> Simpan Muzakki
                </button>
            </div>
        </form>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (postalCodeInput && postalCodeInput.value.trim() !== '' && postalCodeInput.value.trim().length !== 5) {
            e.preventDefault();
            Swal.fire({
                icon: 'warning',
                title: 'Kode Pos Salah',
                text: 'Kode pos harus terdiri dari tepat 5 digit angka!',
                confirmButtonColor: '#c2410c'
            });
