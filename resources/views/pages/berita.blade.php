...
<div class="bg-gray-50 min-h-screen pt-32 pb-20">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-16">
            <h1 class="text-4xl md:text-5xl font-black text-gray-900 mb-4">Berita Lazismu Banten</h1>
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">Update terbaru seputar program zakat, infaq, dan sedekah yang telah tersalurkan untuk membantu sesama</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-200 flex flex-col">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        <div class="flex items-center text-sm text-gray-500 mb-3">
                            <span class="font-medium text-orange-600">{{ $item->category_label ?? 'Berita' }}</span>
                            <span class="mx-2">•</span>
                            <span>{{ $item->created_at->format('d M Y') }}</span>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 leading-snug">
                            <a href="{{ route('news.show', $item->slug) }}" class="hover:text-orange-600 transition-colors">
                                {{ $item->title }}
                            </a>
                        </h3>
                        ...
                        <div class="mt-auto flex items-center justify-between pt-4 border-t border-gray-50">
                            ...
                            <a href="{{ route('news.show', $item->slug) }}" class="text-orange-600 hover:text-orange-700 font-medium text-sm flex items-center group">
                                Baca 
            ...
            @empty
                <div class="col-span-full text-center py-20 bg-white rounded-xl border border-gray-100">
                    ...
                    <p class="text-gray-500 mt-1">Berita akan muncul di sini setelah ditambahkan.</p>
                </div>
            @endforelse
        </div>
