...
<div class="px-4 sm:px-6 py-5 w-full mx-auto" style="max-width: 1280px;">
                ...
                <div class="flex-1 min-w-[220px]">
                    <div class="relative">
                        ...
                        <input type="text" id="search" name="search"
                            ...
                            placeholder="Cari kode distribusi, nama mustahik..." value="{{ request('search') }}"
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        ...
        <div class="rounded-2xl p-5" style="background: #fff; box-shadow: 0 1px 3px rgba(28,15,10,0.04);">
            <p class="text-xs font-medium leading-tight" style="color: #8b7e74;">Total nominal keluar</p>
            ...
            <table id="table-reports-outgoing" class="min-w-full divide-y divide-[#f0ece6]">
                <thead style="background: #faf8f5;">
                    <tr>
                        ...
                        <th class="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider" style="color: #8b7e74;">Nama Mustahik</th>
                        <th class="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider" style="color: #8b7e74;">Kategori</th>
                        <th class="px-5 py-3.5 text-center text-xs font-semibold uppercase tracking-wider" style="color: #8b7e74;">Jenis</th>
                ...
                <tbody class="bg-white divide-y divide-[#f0ece6]">
                    ...
                    <tr class="hover:bg-[#faf8f5]/60 transition-colors duration-150">
                        ...
                        <td class="px-5 py-4 whitespace-nowrap text-center text-xs font-medium" style="color: #8b7e74;">
                            ...
                            @case('goods') Barang @break
                            @case('voucher') Voucher @break
                            @case('service') Layanan @break
                            @endswitch
                        </td>
                        <td class="px-5 py-4 whitespace-nowrap text-center text-xs font-bold text-[#c2410c]">Rp {{ number_format($distribution->amount, 0, ',', '.') }}</td>
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-sm font-semibold mb-0" style="color: #1c0f0a;">Tidak ada data laporan keluar</p>
